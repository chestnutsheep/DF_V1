...
from deep_fusion.shared.utils import compute_kondratiev as _ck
from deep_fusion.shared.spectral import cf_bandpass, phase_from_waveform
...
def _compute_kondratiev(method: str = "pca"):
    ...
    from deep_fusion.shared.utils import fetch_wb
...
def _calc_kondratiev_bandpass() -> tuple[dict, list]:
    ...
    from deep_fusion.shared.utils import compute_kondratiev as _ck
    from deep_fusion.shared.spectral import phase_from_waveform
